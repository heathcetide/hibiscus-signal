 ...
 * 解决事件驱动架构中的关键问题
 */
public class TransactionAndRecoveryDemo {

    public static void main(String[] args) {
        System.out.println("=== 事务隔离和事件恢复演示 ===\n");
    ...
    private static void demonstrateTransactionIsolation() {
        ...
        try {
            ...
            properties.setPersistenceFile("transaction-demo.json");
    ...
    private static void demonstrateEventReplay() {
        ...
        try {
            ...
            properties.setPersistent(true);
            properties.setPersistenceDirectory("logs/signals");
            properties.setPersistenceFile("replay-demo.json");
    ...
    private static void demonstrateEventRecovery() {
        ...
        try {
            ...
            properties.setPersistent(true);
            properties.setPersistenceDirectory("logs/signals");
            properties.setPersistenceFile("recovery-demo.json");
            ...
            // 模拟从持久化文件恢复事件
            simulateEventRecovery(newSignals, properties);
     ...
     * 模拟事件恢复
     */
    private static void simulateEventRecovery(Signals signals, SignalProperties properties) {
        try {
            String persistenceFile = properties.getPersistenceDirectory() + "/" + properties.getPersistenceFile();
            
            // 模拟从持久化文件读取事件
            System.out.println("      📂 从持久化文件读取事件: " + persistenceFile);
